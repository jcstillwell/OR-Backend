...
from .authenticate import authenticate_invoice, verification_email
    ...
    def post(self, request):
        if request.data:
            ...
            if len(query) > 0:
                ...
                verification_email(source_email, to_email, email_password, f"http://localhost:8000/verify?token={tempUser.token}")
